...
import { audienceLeads, merge, AudienceFilter } from "@/lib/comms";

const MAX = 500;
const SMS_COST_CENTS = 1;

function emailHtml(bodyText: string, toEmail: string) {
  ...
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:14px;overflow:hidden;border:1px solid #e6e8ee">
    ...
    <div style="padding:22px;color:#1b2330;font-size:15px;line-height:1.55">${safe}
      <p style="margin-top:22px"><a href="tel:18006334427" style="background:linear-gradient(120deg,#16d6a5,#1e8bff);color:#03110d;text-decoration:none;font-weight:700;padding:11px 18px;border-radius:10px;display:inline-block">Call 1-800-MEDIGAP</a></p>
    </div>
