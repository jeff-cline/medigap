...
export default function AgeTechPage() {
  return (
    <div id="top">
      ...
      <section className="border-y border-[var(--ag-border)] bg-[var(--ag-bg2)]">
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          <p className="text-2xl md:text-3xl font-medium leading-snug">
            ...
            R0cketShip monetizes the same customer <span className="ag-gradient font-bold">repeatedly, across decades</span> — through products, services, partnerships and acquisitions.
          </p>
      ...
      <Section id="ecosystem" n="02" eyebrow="The Ecosystem" title={<>One trusted layer, <span className="ag-gradient">an expanding universe.</span></>} sub="R0cketShip sits at the center of every aging-related decision — each node a revenue pathway, each connection routed through the trust layer.">
        <EcosystemMap />
      </Section>
      ...
      <Section id="demand" n="06" eyebrow="The Demand Engine" title={<>Owned acquisition, <span className="ag-gradient">end to end.</span></>} sub="From traffic to revenue activation — a closed loop R0cketShip controls and re-monetizes.">
        <DemandEngine />
      </Section>
